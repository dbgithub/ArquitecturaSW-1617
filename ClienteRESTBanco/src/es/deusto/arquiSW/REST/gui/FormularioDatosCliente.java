							...
							.addGroup(gl_panel.createSequentialGroup()
								...
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING, false)
										...
										.addComponent(textFieldNombre, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)))
								.addGap(25))
							.addGroup(gl_panel.createSequentialGroup()
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
											.addComponent(textFieldEmail, GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE)
											.addGroup(gl_panel.createSequentialGroup()
												.addComponent(textFieldPIN, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED))
											.addGroup(gl_panel.createSequentialGroup()
												.addComponent(textFieldMovil, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)))
										.addGroup(gl_panel.createSequentialGroup()
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(checkBox, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)))
									.addComponent(textFieldDireccion, GroupLayout.PREFERRED_SIZE, 365, GroupLayout.PREFERRED_SIZE))
								.addContainerGap()))
