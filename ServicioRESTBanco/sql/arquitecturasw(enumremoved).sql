...
CREATE TABLE `tarjeta` (
  ...
  CONSTRAINT `fk_IBANcuenta_tar` FOREIGN KEY (`Cuenta`) REFERENCES `cuenta` (`IBAN`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-19 16:33:30
