...
/**
 * This util class converts DTO classes to the type of class we are working on throughout all project.
 * @author aitor & daniel
 *
 */
public class DTOClassesConversor {
	...
	public Operacion DTOOperacionToOperacion(OperacionDTO dto) {
		return new Operacion(dto.getId(), dto.getFecha(), dto.getTipo(),dto.getImporte(), null);
	...
	public Tarjeta DTOTarjetaToTarjeta(TarjetaDTO dto) {
		...
		return new Tarjeta(dto.getNumero(), c, dto.getLimiteExtraccion(), dto.getFechaCaducidad(), dto.getProveedor(), dto.getTipo(), dto.getFechaExpedicion());
	...
	public OperacionDTO OperacionToDTOOperacion(Operacion o) {
		return new OperacionDTO(o.getId(), o.getFecha(), o.getTipo(),o.getImporte(), 0);
	}

	public TarjetaDTO TarjetaToDTOTarjeta(Tarjeta t) {
		return new TarjetaDTO(t.getNumero(), t.getCuenta().getIBAN(), t.getLimiteExtraccion(), t.getFechaCaducidad(),t.getProveedor(),t.getTipo(), t.getFechaExpedicion());
	}
}
