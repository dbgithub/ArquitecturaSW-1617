	...
	<body data-spy="scroll" data-target="#navbar-example">
			...
			<div id="overlay-1">
				...
				<section id="starting">
					<div class="text-center starting-text wow animated zoomInDown">
						...
						<h1 class="rene">Smart App Design</h1>
				    ...
				    <div class="services">
			        	<div class="row">
			        		<div class="col-md-3 col-sm-6">
			        			<div class="service">
			        				<img src="../imgs/service1.png" alt="service1">
			        		...
			        		<div class="col-md-3 col-sm-6">
			        			<div class="service">
			        				<img src="../imgs/service4.png" alt="service1">
			        				<div class="text-center">
				        				<h4>Web Design</h4>
				        				<p>
				        					Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
			    ...
			    <div class="main_content">
				    <div class="container">
			        	<div class="row">
			        		<div class="col-md-3 col-sm-6">
			        			<div class="meet-item">
			        				<img src="../imgs/meet1.png" alt="meet1">
			        				<div class="text-center">
				        				<h4>SMITH</h4>
				        				<p>
				        					PROJECT MANAGER
			        		...
			        		<div class="col-md-3 col-sm-6">
			        			<div class="meet-item">
			        				<img src="../imgs/meet2.png" alt="meet1">
			        				<div class="text-center">
				        				<h4>JEMS</h4>
				        				<p>
				        					PROJECT MANAGER
			        		...
			        		<div class="col-md-3 col-sm-6">
			        			<div class="meet-item">
			        				<img src="../imgs/meet3.png" alt="meet1">
			        				<div class="text-center">
				        				<h4>RIQE</h4>
				        				<p>
				        					PROGRAMMER
			        		...
			        		<div class="col-md-3 col-sm-6">
			        			<div class="meet-item">
			        				<img src="../imgs/meet4.png" alt="meet1">
			        				<div class="text-center">
				        				<h4>MORINHO</h4>
				        				<p>
				        					PROGRAMMER
				    ...
				    <div class="container">
						...
						<div class="col-xs-12">
							<div id="screenshots-wrap" class="owl-carousel owl-theme">
								<a href="../imgs/screenShoot1.png" class="item" 	data-lightbox-gallery="screenshots">
								  	<img src="../imgs/screenShoot1.png" class="img_res wow animated zoomIn" alt="">
								</a>

								<a href="../imgs/screenShoot2.png" class="item" 	data-lightbox-gallery="screenshots">
								  	<img src="../imgs/screenShoot2.png" class="img_res wow animated zoomIn" alt="">
								</a>
								<a href="../imgs/screenShoot3.png" class="item" 	data-lightbox-gallery="screenshots">
								  	<img src="../imgs/screenShoot3.png" class="img_res wow animated zoomIn" alt="">
								</a>

								<a href="../imgs/screenShoot4.png" class="item" 	data-lightbox-gallery="screenshots">
								  	<img src="../imgs/screenShoot4.png" class="img_res wow animated zoomIn" alt="">
								</a>
								<a href="../imgs/screenShoot1.png" class="item" 	data-lightbox-gallery="screenshots">
								  	<img src="../imgs/screenShoot1.png" class="img_res wow animated zoomIn" alt="">
								</a>
		...
		<section id="subscribe">
			<div class="container text-center">
				...
				<a class="btn btn-sub btn-primary" href="#" role="button">SUBSCRIBE</a>
			</div> <!-- .container -->
		</section> <!-- #subscribe -->
	    		...
	    		<div class="row main_content">
	    			<div class="col-md-10 col-md-offset-1">
	    				<div id="client-speech" class="owl-carousel owl-theme">
							<div class="item">
								<img class="img-circle img-responsive center-block" src="../imgs/test1.png" alt="text">
							...
							<div class="item">
								<img class="img-circle img-responsive center-block" src="../imgs/test2.png" alt="text">
								<p class="client-comment text-center">
									When you form a team, why do you try to form a team? Because teamwork builds trust and trust builds speed.When you form a team, why do you try to form a team? Because teamwork builds trust and trust builds speed.
								</p>
								<div class="row text-center">
							...
							<div class="item">
								<img class="img-circle img-responsive center-block" src="../imgs/test3.png" alt="text">
								<p class="client-comment text-center">
									When you form a team, why do you try to form a team? Because teamwork builds trust and trust builds speed.When you form a team, why do you try to form a team? Because teamwork builds trust and trust builds speed.
								</p>
								<div class="row text-center">
