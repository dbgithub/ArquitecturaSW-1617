					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbar-example">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="#about" class="active"><s:text
											name="li.quepuedo" /></a></li>
			...
			<section id="starting">
				<div class="text-center starting-text wow animated zoomInDown">
					...
					<div class="cuadro_datos">
						...
						<p>
							<s:text name="p.DNI" />
							: <span><s:if test="DNI == null">
									<s:property value="#session.dni" />
								</s:if>
								<s:else>
						...
						<p>
							<s:text name="p.Movil" />
							: <span><s:if test="Movil == null">
									<s:property value="#session.movil" />
								</s:if>
								<s:else>
									<s:property value="Movil" />
								</s:else></span>
						</p>
					</div>

					<s:if test="%{cuentas==null}">
						<p class="text-danger">Usted no tiene registrada ninguna
							cuenta a su nombre</p>
					</s:if>
					<s:else>
						<table>
							<tr>
							...
							<s:iterator value="cuentas">
								<tr>
									<td><s:url var="urlIBAN" action="showOperaciones">
											<s:param name="IBAN" value="%{IBAN}" />
											<%-- Otra forma: <s:param name="IBAN"><s:property value="IBAN"/></s:param> --%>
										</s:url> <s:a href="%{urlIBAN}"
											tooltip="%{getText('tooltip.veroperaciones')}">
											<s:property value="IBAN" />
										</s:a></td>
						...
						<div class="transferencias">
							<s:url var="urlDNI" action="Transferencias">
	...
	<section id="about">
		<div class="container">
			...
			<div class="row about-us-text">
				<div class="col-md-12">
					<p class="text-center">
						<s:text name="application.explicacion" />
					</p>
				</div>
			</div>
			<!-- row -->
			<div class="row main_content">
				<div class="col-md-4 col-sm-4 wow animated zoomIn"
					...
					<h5 class="text-center">
						<s:text name="application.feature1" />
					</h5>
				</div>
				<!-- col-md-4 -->
				...
				<div class="col-md-4 col-sm-4 wow animated zoomIn"
					...
					<h5 class="text-center">
						<s:text name="application.feature2" />
					</h5>
				</div>
				<!-- col-md-4 -->
				...
				<div class="col-md-4 col-sm-4 wow animated zoomIn"
					...
					<h5 class="text-center">
						<s:text name="application.feature3" />
					</h5>
				</div>
				<!-- col-md-4 -->
			</div>
