			...
			<section id="starting">
				<div class="text-center starting-text wow animated zoomInDown">
					...
					<div class="cuadro_datos">
						<p>
							DNI: <span><s:property value="DNI" /></span>
						</p>
						<p>
							Email: <span><s:property value="Email" /></span>
						</p>
						<p>
							Móvil: <span><s:property value="Movil" /></span>
						</p>
					</div>
							...
							<s:iterator value="cuentas">
								<tr>
									...
									<td><s:url var="urlIBAN" action="showOperaciones">
										...
										</s:url> <s:a href="%{urlIBAN}" tooltip="Ver operaciones de la cuenta">
